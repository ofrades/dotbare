...
local on_attach = function(client, bufnr)
	...
	buf_set_keymap("n", "<leader>xr", "<cmd>Trouble lsp_references<cr>", { silent = true, noremap = true })
...
nvim_lsp.dockerfile.setup({ on_attach = on_attach, capabilities = capabilities })
