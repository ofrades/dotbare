...
return require("packer").startup(
  function()
    ...
    use { "TimUntersberger/neogit", config = function () require("neogit").setup() end } -- Magit
    use { "lewis6991/gitsigns.nvim", config = function() require('gitsigns').setup() end } -- git signs
