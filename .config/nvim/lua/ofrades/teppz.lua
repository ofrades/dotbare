...
Group.new("LineNr", c.grey600, c.none, no)
...
Group.new("NormalFloat", c.none, c.grey900, i)
...
Group.new("Conditional", c.grey300, c.none, no)
Group.new("QuickFixLine", g.Search, g.Search, g.Search)
Group.new("TabLine", c.grey500, c.dark, no)
