...
Group.new("IncSearch", nil, nil, s.reverse)
...
Group.new("StatusLine", nil, c.grey800)
...
Group.new("Normal", c.grey100)
Group.new("NormalFloat", nil, c.dark, s.italic)
Group.new("Question", c.blue700, nil, s.bold)
...
Group.new("TabLineSel", c.dark, c.blue700)
...
Group.new("TSConstant", c.blue700)
...
Group.new("TSStringEscape", c.blue700)
...
Group.new("htmlH1", c.blue700, nil, s.bold)
...
Group.new("markdownH6", c.blue700)
