...
let s:configuration.enable_italic = get(g:, 'teppz_italic', 1)
let s:configuration.disable_italic_comment = get(g:, 'teppz_italic_comments', 0)
let s:configuration.enable_bold = get(g:, 'teppz_bold', 1)
let s:configuration.cursor = get(g:, 'teppz_cursor', 'auto')
let s:configuration.current_word = get(g:, 'teppz_current_word', get(g:, 'teppz_transparent_background', 0) == 0 ? 'grey background' : 'bold')
...
let s:palette = {
      ...
      \ 'null':       ['#58659a',      '2', 'Null'],
      \ 'numbers':       ['#609ad2',      '3', 'Numbers'],
      \ 'strings':       ['#60c1d1',      '4', 'Strings'],
      \ 'escape':       ['#588e9a',      '5', 'Escape'],
      \ 'chars':       ['#5fd2be',      '6', 'Chars'],
      \ 'functions':       ['#4ca585',      '7', 'Functions'],
      \ 'support':       ['#497c6c',      '8', 'Support'],
      \ 'unused':       ['#b0c87d',      '9', 'Unused'],
      \ 'unused2':       ['#85946b',      '10', 'Unused2'],
      \ 'variables':       ['#d9c679',      '11', 'Variables'],
      \ 'local':       ['#9d936b',      '12', 'Local'],
      \ 'preprocessor':       ['#dbba7f',      '13', 'Preprocessor'],
      \ 'entities':       ['#7d705f',      '14', 'Entities'],
      \ 'keywords':       ['#cea37f',      '15', 'Keywords'],
      \ 'other':       ['#98816f',      '16', 'Other'],
      \ 'declarations':       ['#d88e78',      '17', 'Declarations'],
...
" }}}
" Syntax: {{{
call s:HL('Boolean', s:palette.variables, s:palette.none)
call s:HL('Number', s:palette.numbers, s:palette.none)
call s:HL('Float', s:palette.numbers, s:palette.none)
if s:configuration.enable_italic
  ...
  call s:HL('Keyword', s:palette.keywords, s:palette.none, 'italic')
  call s:HL('Typedef', s:palette.types, s:palette.none, 'italic')
  ...
  call s:HL('Keyword', s:palette.keywords, s:palette.none)
  call s:HL('Typedef', s:palette.types, s:palette.none)
...
if s:configuration.enable_bold
  call s:HL('StorageClass', s:palette.built, s:palette.none, 'bold')
  call s:HL('Title', s:palette.orange, s:palette.none, 'bold')
  call s:HL('Type', s:palette.types, s:palette.none, 'bold')
  call s:HL('Function', s:palette.functions, s:palette.none, 'bold')
  call s:HL('Constant', s:palette.constant, s:palette.none, 'bold')
else 
  call s:HL('StorageClass', s:palette.built, s:palette.none)
  call s:HL('Title', s:palette.orange, s:palette.none)
  call s:HL('Type', s:palette.types, s:palette.none)
  call s:HL('Function', s:palette.functions, s:palette.none)
  call s:HL('Constant', s:palette.constant, s:palette.none)
  call s:HL('Conditional', s:palette.other, s:palette.none)
endif
...
call s:HL('Structure', s:palette.entities, s:palette.none)
call s:HL('Operator', s:palette.orange, s:palette.none)
call s:HL('Special', s:palette.yellow, s:palette.none)
call s:HL('SpecialChar', s:palette.chars, s:palette.none)
call s:HL('Character', s:palette.chars, s:palette.none)
call s:HL('Macro', s:palette.cyan, s:palette.none)
call s:HL('Identifier', s:palette.variables, s:palette.none)
call s:HL('SpecialKey', s:palette.blue, s:palette.none)
if s:configuration.enable_italic_string
  call s:HL('String', s:palette.strings, s:palette.none, 'italic')
else
...
" Noun
call s:HL('Constant', s:palette.constant, s:palette.none)
call s:HL('Null', s:palette.null, s:palette.none)
call s:HL('Numbers', s:palette.numbers, s:palette.none)
call s:HL('Strings', s:palette.strings, s:palette.none)
call s:HL('Escape', s:palette.escape, s:palette.none)
call s:HL('Chars', s:palette.chars, s:palette.none)

" Verb
call s:HL('Functions', s:palette.functions, s:palette.none)
call s:HL('Support', s:palette.support, s:palette.none)
call s:HL('Unused', s:palette.unused, s:palette.none)
call s:HL('Unused2', s:palette.unused2, s:palette.none)

" Subject
call s:HL('Variables', s:palette.variables, s:palette.none)
call s:HL('Local', s:palette.local, s:palette.none)
call s:HL('Preprocessor', s:palette.preprocessor, s:palette.none)
call s:HL('Entities', s:palette.entities, s:palette.none)
call s:HL('Keywords', s:palette.keywords, s:palette.none)
call s:HL('Other', s:palette.other, s:palette.none)

" Adjectives
call s:HL('Declarations', s:palette.declarations, s:palette.none)
call s:HL('Inherited', s:palette.inherited, s:palette.none)
call s:HL('Types', s:palette.types, s:palette.none)
call s:HL('Built', s:palette.built, s:palette.none)
call s:HL('Modifier', s:palette.modifier, s:palette.none)
...
highlight! link markdownIdDeclaration Desclarations
...
highlight! link xmlDocTypeKeyword Keywords
...
highlight! link cssFunctionName Green
...
highlight! link sassFunction Green
...
highlight! link scssVariableValue Variables
highlight! link scssNull Null
highlight! link scssBoolean Purple
highlight! link scssVariableAssignment Grey
highlight! link scssForKeyword Keywords
highlight! link scssAttribute Orange
highlight! link scssFunctionName Green
" }}}
" }}}
" LESS: {{{
...
highlight! link lessVariable Variables
highlight! link lessAmpersandChar Orange
highlight! link lessFunction Green
" }}}
" }}}
" JavaScript: {{{
" builtin: http://www.fleiner.com/vim/syntax/javascript.vim{{{
highlight! link javaScriptNull Null
...
highlight! link javaScriptFunction Green
...
highlight! link jsNull Null
highlight! link jsNan Cyan
highlight! link jsSuper Types
highlight! link jsPrototype Types
highlight! link jsFunction Green
...
highlight! link jsVariableDef Variables
...
highlight! link javascriptVariable Variables
highlight! link javascriptObjectLabel Cyan
highlight! link javascriptObjectLabelColon Grey
highlight! link javascriptPropertyNameString Strings
...
highlight! link typescriptSource Keywords
highlight! link typescriptMessage Yellow
highlight! link typescriptGlobalObjects Types
...
highlight! link typescriptMethodAccessor Functions
highlight! link typescriptVariable Variables
highlight! link typescriptVariableDeclaration Declarations
highlight! link typescriptTypeReference Types
highlight! link typescriptBraces Fg
highlight! link typescriptEnumKeyword Keywords
highlight! link typescriptEnum Yellow
highlight! link typescriptIdentifierName Cyan
highlight! link typescriptProp Cyan
highlight! link typescriptCall Green
highlight! link typescriptInterfaceName Yellow
highlight! link typescriptEndColons Fg
highlight! link typescriptMember Preprocessor
...
highlight! link typescriptClassName Types
highlight! link typescriptClassHeritage Types
...
highlight! link typescriptReadonlyModifier Modifier
highlight! link typescriptAccessibilityModifier Mofifier
highlight! link typescriptAmbientDeclaration Declarations
...
highlight! link typescriptCastKeyword Keywords
highlight! link typescriptOptionalMark Orange
highlight! link typescriptNull Null
...
highlight! link typescriptStringProperty Strings
...
highlight! link typescriptNumberStaticProp Numbers
...
highlight! link csType Built
highlight! link csTypeOfStatement Built
highlight! link csClassType Types
highlight! link csClass Types
highlight! link csRepeat Support
highlight! link csIsType Types
highlight! link csStorage Types
highlight! link csClass RedItalic
highlight! link csModifier Modifier
highlight! link csConditional Preprocessor
highlight! link csConstant Constant
highlight! link csException Other
highlight! link csTypeOf Keywords
highlight! link csUnspecifiedKeyword Keywords
highlight! link csNew Keywords
highlight! link csNewType Keywords
highlight! link csLinq Keywords
highlight! link csIsAs Keywords
highlight! link csAsync Keywords

highlight! link csComment	Grey

highlight! link csNumber Numbers
highlight! link csCharacter Chars
highlight! link csString Strings
highlight! link csQuote Strings
highlight! link csInterpolationString Strings
highlight! link csVerbatimString Strings
highlight! link csInterVerbString Strings

highlight! link csUnspecifiedStatement Null
highlight! link csContextualStatement Null
...
" Python: {{{
" builtin: {{{
highlight! link pythonBuiltin Built
...
highlight! link pythonBuiltinType Built
highlight! link pythonBuiltinObj Built
...
highlight! link ktKeyword Keywords
" }}}
" }}}
" Scala: {{{
...
highlight! link scalaKeywordModifier Modifier
" }}}
" }}}
" Go: {{{
...
highlight! link goBuiltins Built
...
highlight! link swiftTypeDeclaration Declarations
...
highlight! link haskellDeclKeyword Keywords
highlight! link haskellWhere RedItalic
highlight! link haskellDeriving PurpleItalic
highlight! link haskellForeignKeywords Keywords
" }}}
" }}}
" Perl: {{{
...
highlight! link erlangLocalFuncRef Local
...
highlight! link elixirKeyword Keywords
...
highlight! link elixirPseudoVariable Variables
...
highlight! link clojureKeyword Keywords
highlight! link clojureVariable Variables
...
highlight! link shVariable Variables
...
highlight! link zshVariableDef Variables
" }}}
" }}}
" Fish: {{{
...
highlight! link cmakeKWvariable_requires Variables
highlight! link cmakeKWvariable_watch Variables
highlight! link cmakeKWwrite_file Cyan
" }}}
" Json: {{{
highlight! link jsonKeyword Keywords
