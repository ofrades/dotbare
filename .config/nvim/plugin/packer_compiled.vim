...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    config = { "\27LJ\2\nm\0\0\3\0\4\0\0166\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\0016\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\0016\0\0\0'\2\3\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\15lspinstall\nsetup\17nlspsettings\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-web-devicons', 'express_line.nvim', 'vim-startify', 'gruvbox-flat.nvim', 'committia.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'LuaSnip'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-compe'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'null-ls.nvim', 'nvim-spectre', 'nvim-treesitter', 'nvim-ts-context-commentstring', 'orgmode.nvim', 'telescope.nvim', 'todo-comments.nvim', 'vim-commentary', 'vim-hexokinase', 'vim-rooter', 'neogit', 'vim-smoothie', 'vim-visual-multi', 'which-key.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'lightspeed.nvim', 'lir.nvim', 'trouble.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
